<div class="navbar__wrapper container-fluid">
    <div class="navbar__contents container d-flex justify-content-between pt-2 align-items-center">
        <div class="navbar__logo">
            <a href="/" class="logo navbar-brand"><img src="{{ asset('images/logo.png') }}" alt=""></a>
        </div>
        <div class="navbar-links__wrapper">
